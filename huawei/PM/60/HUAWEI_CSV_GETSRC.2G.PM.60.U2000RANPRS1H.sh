...
CFG="/home/huawei/program/scripts/2G/HUAWEI_CSV_GETSRC/PM/60/HUAWEI_CSV_GETSRC.2G.PM.60.U2000RANPRS1H.cfg"
mode=${1}
dateYMDH=${2}
dateYMD=${dateYMDH:0:8}
period=${3}
type=${4}
DETAIL=`cat ${CONFIG} | grep ${type} | grep 'PM|2G|60|6|U2000RANPRS1H'`
...
PATH_TMP="/data/huawei/temp/HUAWEI_CSV_GETSRC/U2000RANPRS1H/SOURCE/${dateYMD}"
PATH_TARGET="/data/huawei/temp/HUAWEI_CSV_GETSRC/U2000RANPRS1H/${dateYMD}"
PATH_LOG="/data/huawei/temp/HUAWEI_CSV_GETSRC/U2000RANPRS1H/log/$(date +"%Y%m%d")"
...
MOVE_FILE_TMP () 
{
	...
	#delete old source
	dirDel="/data/huawei/temp/HUAWEI_CSV_GETSRC/U2000RANPRS1H/SOURCE/"$(date --date="-7 day" "+%Y%m%d")
	if [ -d "$dirDel" ]; then
